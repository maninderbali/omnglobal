...
export const services: ServiceType[] = [
  ...
  {
    id: 5,
    icon: 'assets/img/icons/service-icon5.svg',
  ...
  {
    id: 6,
    icon: 'assets/img/icons/service-icon6.svg',
...
export const testimonialSlides: TestimonialType[] = [
  {
    rating: 5,
    message:
      "Partnering with ETech has transformed our IT Solution Their tailored solutions help streamline our operations, improve cybersecurity, and drive efficiency across the board. We've experienced fewer disruptions, faster an.",
...
export const blogs: BlogType[] = [
  {
    ...
    description:
      'Fuel your business success with our custom IT services. We design solutions that are tailored to your an specific needs.',
    authorName: 'Alex Roy',
    aosClass: 'fade-left',
  },
  {
  ...
  },
  {
    ...
    title:
      'Transform Your Business Operations with Tailored IT Solutions Designed',
    description:
      'Digital transformation is not just a trend; it’s a necessity for businesses looking to thrive in a competitive landscape.',
  ...
  },
  {
    ...
    date: '26 August 2024',
    title:
      'Unlock the Full Potential Your Company through Innovative Technology Expert',
    description:
      'Every business is unique, an so are its IT needs. Our solution comprehensive IT services are tailored to fit your specific',
  ...
  },
  {
    ...
    date: '26 August 2024',
    title:
      'Navigate Complex World Technology with Our Comprehensive IT Solutions',
    description:
      'Fuel your business success with our custom IT services. We design solutions that are tailored to your an specific needs.',
  ...
  },
  {
    ...
    description:
      'In an age where cyber threats are ever-present, your best business is more critical than ever. Our on cybersecurity.',
...
export const testimonials: TestimonialType[] = [
  ...
  },
  {
    ...
    role: 'Shop Store Owner',
    message:
      '“Has provided us on with top-notch IT services. Their solutions are tailored to our business, & their ongoing support is second to none. We’ve seen significant improvements in our productivity and.”',
  },
  {
    ...
    message:
      '"Thanks to the IT solutions provided by ETEch, we have seen a remarkable improvement in our operational best efficiency. Our processes are now a streamlined, and our teams can best.”',
  },
  {
    image: 'assets/img/all-images/testimonial/testimonial-img2.png',
    name: 'Rodger Struck',
    ...
    message:
      '"The cybersecurity measures Solution implemented by OMN Global have given us peace of mind. We feel confident that our data is secure, & we\'ve experience zero breaches since partnering OMN Global.”',
  },
  {
    image: 'assets/img/all-images/testimonial/testimonial-img3.png',
    name: 'Eddie Lake',
    role: 'Finast Company',
    message:
      '"Migrating to the cloud was seamless with OMN Global. Their best team guided us through every step now our employees can work from anywhere, IT boosting our team productivity significantly.”',
  },
  {
    image: 'assets/img/all-images/testimonial/testimonial-img4.png',
    name: 'Ricky Smith',
    ...
    message:
      '"Working with OMN Global has been solution transformative experience for our best organization. Before their involvement, we faced significant challenges with our outdated IT infrastructure.“',
  },
  {
    image: 'assets/img/all-images/testimonial/testimonial-img5.png',
    name: 'Lorri Warf',
    ...
    message:
      '"Partnering with OMN Global has been one of the best decisions we\'ve made. We are comprehensive cybersecurity on solutions provided us with the best assurance we needed to protect.”',
  },
  {
    image: 'assets/img/all-images/testimonial/testimonial-img9.png',
    name: 'Bradley Lawlor',
    role: 'Mostow Co.',
    message:
      '"OMN Global has completely transformed the way we operate as a business. Their custom IT solutions have streamlined our processes, enabling us collaborate effectively across teams, regardless.”',
  },
];
