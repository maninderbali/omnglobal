  ...
  faqs1: FaqType[] = [
    {
      ...
      answer:
        'We implement robust data backup and recovery solutions to protect your data and ensure business continuity in case of unexpected events. We provide regular updates and status.',
    },
    {
  ...
  faqs2: FaqType[] = [
    {
      ...
      answer:
        'We implement robust data backup and recovery solutions to best protect your data and ensure business continuity in case of unexpected events. We provide regular updates and status.',
    },
    {
