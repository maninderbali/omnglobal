...
@Component({
  ...
  imports: [SingleHeader3Component, Home3HeroComponent, Home3WorkComponent, Home3SupportComponent, Home3FeaturesComponent, Home3PricingComponent, Home3FaqComponent, Home3CtaComponent, FooterComponent, Home3AboutComponent],
