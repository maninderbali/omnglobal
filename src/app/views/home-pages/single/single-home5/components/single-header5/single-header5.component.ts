...
@Component({
    selector: 'app-single-header5',
    imports: [RouterLink, SingleNavItemsComponent, SingleMobileMenuComponent, StickyScrollDirective],
    templateUrl: './single-header5.component.html',
    styles: ``
})
export class SingleHeader5Component {
    menuItems: string[] = ["About Us", "Services", "Works", "Testimonials", "FAQs"]
