...
import { SingleHeader2Component } from "./components/single-header2/single-header2.component";
...
@Component({
    selector: 'app-single-home2',
    imports: [SingleHeader2Component, Home2HeroComponent, Home2AboutComponent, Home2WorkComponent, Home2ServicesComponent, Home2TestimonialComponent, Home2TeamComponent, Home2BlogsComponent, Home2CtaComponent, FooterComponent],
    templateUrl: './single-home2.component.html',
    styles: ``
})
export class SingleHome2Component implements OnInit, OnDestroy {
